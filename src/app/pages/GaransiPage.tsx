  ...
  if (loading) return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
        ...
        <div className="divide-y divide-gray-100">{[...Array(5)].map((_, i) => (<div key={i} className="px-4 py-1.5 flex gap-4"><div className="h-4 bg-accent rounded w-1/4" /><div className="h-4 bg-accent rounded w-1/6" /><div className="h-4 bg-accent rounded w-1/6" /><div className="h-4 bg-accent rounded w-1/6 ml-auto" /></div>))}</div>
      </div>
    </div>
  );
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-3 flex-1 overflow-y-auto md:max-h-[70vh]">
              ...
              <div className="flex justify-end gap-2 pt-3 sticky bottom-0 bg-card mt-auto md:mt-0 border-t border-border md:border-none md:pt-2">
                ...
                <button
                  ...
                  className="flex-1 md:flex-none px-3 py-1.5 md:py-1.5 bg-[#3B82F6] text-white rounded-xl md:rounded-lg hover:bg-[#2563EB] transition-colors disabled:opacity-50 text-xs font-bold shadow-sm active:scale-[0.98]"
                >
