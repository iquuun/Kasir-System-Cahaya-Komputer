          ...
          {currentItems.length === 0 ? (
            ...
            <div key={product.id} className="p-2.5 space-y-1.5 hover:bg-muted transition-colors">
              ...
              <div className="flex justify-end items-center pt-1.5 border-t border-border gap-2">
                ...
                <button
                  onClick={() => handleDelete(product.id, product.name)}
                  className="px-2 py-1 bg-red-50 text-red-600 rounded text-[10px] font-bold flex items-center gap-1"
                >
          ...
          <div className="bg-card md:rounded-2xl shadow-2xl ring-1 ring-white/50 modal-content w-full max-w-2xl overflow-hidden h-full md:h-auto md:max-h-[90vh] flex flex-col">
            <div className="p-3 md:p-4 border-b border-border shrink-0 bg-muted/50 sticky top-0 z-20">
              <div className="flex items-center gap-3">
                ...
                <div className={`hidden md:block p-2 rounded-lg ${modalMode === 'add' ? 'bg-blue-50 text-blue-600' : 'bg-amber-50 text-amber-600'}`}>
                    ...
                    {isAddingCategory ? (
                      <div className="flex gap-1 animate-in slide-in-from-right-2 duration-200">
                        ...
                        <button 
                          ...
                          className="p-2 h-[40px] bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 disabled:opacity-50 flex items-center justify-center"
                        >
                          <Check size={14} />
                        </button>
                        <button 
                          ...
                          className="p-2 h-[40px] bg-rose-500 text-white rounded-lg hover:bg-rose-600 flex items-center justify-center"
                        >
                          <X size={14} />
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="w-[40px] h-[40px] flex items-center justify-center bg-blue-50 text-blue-600 border border-blue-100 rounded-lg hover:bg-blue-100 transition-colors shrink-0 dark:bg-blue-900/40 dark:border-blue-800 dark:text-blue-300"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2.5 md:py-2 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none text-xs font-black text-blue-600 bg-blue-50/30 dark:bg-blue-900/20 dark:border-blue-800 dark:text-blue-400"
                    />
                  </div>
                </div>
