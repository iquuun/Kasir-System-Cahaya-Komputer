...
import { Plus, TrendingUp, TrendingDown, Trash2, X, Wallet } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-bold text-gray-800 tracking-tight">Cash Flow</h2>
          <p className="text-gray-500 mt-1 text-xs">Kelola arus kas masuk dan keluar toko</p>
        </div>
        <button
